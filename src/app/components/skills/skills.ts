...
export class Skills {
  skills = signal<Skill[]>([
    ...
    {
      category: "Database & ORM's",
      description: 'Relational and NoSQL data management with modern ORMs',
      color: '#8b5cf6',
      items: [
    ...
    },
    {
      ...
      description: 'Programming languages and essential development utilities',
      color: '#06b6d4',
      items: [
        ...
        { name: 'HTML5', logo: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg?width=32' },
        { name: 'CSS3', logo: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original.svg?width=32' },
