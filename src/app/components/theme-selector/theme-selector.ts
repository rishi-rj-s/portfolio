...
@Component({
  ...
  template: `
    ...
    >
      <div 
        class="bg-[var(--color-card)] border border-[var(--color-border)] rounded-3xl p-6 md:p-8 shadow-2xl max-w-2xl w-full animate-scale-in relative overflow-hidden overflow-y-auto max-h-[90vh]"
      ...
      >
        ...
        <div class="flex items-center justify-between mb-6 relative z-10">
          <div>
            <h2 class="text-2xl font-black font-sans tracking-tight">Customize</h2>
        ...
        <!-- Footer / Hint -->
        <div class="mt-6 text-center text-xs text-[var(--color-text-muted)] font-mono opacity-60">
          PRESS ESC TO CLOSE
        </div>
      </div>
    </div>
